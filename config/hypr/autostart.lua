...
local musicplayer = terminal ..
    " --class cmus -e cmus" -- change this to whatever player you want (replace everything after the '=')
...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("uwsm app -s b -t service -- qs -c calos-shell")
  hl.exec_cmd("systemctl --user start wayland-wm-app-daemon.service")
  ...
  hl.exec_cmd("sleep 2 && " .. musicplayer, { workspace = "special:home silent" })
  ...
  -- hl.exec_cmd("uwsm-app -- steam", { workspace = "special:steamcord silent" })
  -- hl.exec_cmd("uwsm-app -- vesktop", { workspace = "special:steamcord silent" })
end)

...
Item {
    ...
    property color activeBorderColor: root.accent
    ...
    readonly property int totalSpecialTiles: visibleSpecialWorkspaces.length
    ...
    Rectangle { // Background
        ...
        color: ColorUtils.applyAlpha(
            root.glassMode
                ? ColorUtils.mix(root.background, root.background, 0.78 - root.glassTintStrength * 0.35)
                : root.background,
        ...
        border.color: ColorUtils.applyAlpha(
            root.glassMode
                ? ColorUtils.mix(root.border, root.border, 0.52)
                : root.border,
        ...
        ColumnLayout { // Workspaces
                ...
                Repeater {
                    ...
                    Repeater { // Workspace repeater
                        ...
                        Rectangle { // Workspace
                            ...
                            property color defaultWorkspaceColor: root.background
                            property color hoveredWorkspaceColor: ColorUtils.mix(defaultWorkspaceColor, root.accent, 0.1)
                            property color hoveredBorderColor: root.accent
                            ...
                            color: showWallpaper ? "transparent" : ColorUtils.applyAlpha(
                                root.glassMode
                                    ? ColorUtils.mix(hoveredWhileDragging ? hoveredWorkspaceColor : defaultWorkspaceColor, root.background, 0.46)
                            ...
                            Rectangle {
                                ...
                                color: ColorUtils.applyAlpha(
                                    root.glassMode
                                        ? ColorUtils.mix(workspace.hoveredWhileDragging ? workspace.hoveredWorkspaceColor : workspace.defaultWorkspaceColor, root.background, 0.40)
                            ...
                            StyledText {
                                ...
                                color: ColorUtils.transparentize(root.foreground, 0.8)
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: ColorUtils.applyAlpha(
                        root.glassMode
                            ? ColorUtils.mix(root.background, root.background, 0.70)
                            : root.background,
                        root.glassMode ? Math.min(0.74, root.effectivePanelOpacity) : root.effectiveWorkspaceOpacity
                    )
                    border.width: 1
                    border.color: ColorUtils.applyAlpha(root.border, root.glassMode ? root.glassBorderOpacity : 0.65)
                    ...
                    Rectangle {
                        ...
                        radius: parent.radius
                        color: ColorUtils.applyAlpha(root.accent, root.glassMode ? 0.12 : 0.08)
                    }
                    ...
                    StyledText {
                        ...
                        color: ColorUtils.applyAlpha(root.foreground, 0.84)
                    }
                    ...
                    Grid {
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                property color baseColor: ColorUtils.mix(root.background, root.background, 0.52)
                                ...
                                color: showWallpaper ? "transparent" : ColorUtils.applyAlpha(
                                    root.glassMode
                                        ? ColorUtils.mix(baseColor, root.background, 0.44)
                                        : baseColor,
                                    root.effectiveWorkspaceOpacity
                                )
                                border.width: 1
                                border.color: ColorUtils.applyAlpha(root.border, root.glassMode ? root.glassBorderOpacity : 0.75)
                                ...
                                Rectangle {
                                    ...
                                    color: ColorUtils.applyAlpha(
                                        root.glassMode
                                            ? ColorUtils.mix(specialWorkspaceTile.baseColor, root.background, 0.40)
                                        ...
                                        delegate: OverviewWindow {
                                            ...
                                            MouseArea {
                                                ...
                                                onReleased: {
                                                    ...
                                                    root.draggingTargetWorkspace = -1
                                                    root.draggingTargetSpecialWorkspace = ""
                                                    if (targetSpecialWorkspace && targetSpecialWorkspace !== specialWorkspaceTile.specialName) {
                                                        // Idk
                                                        if (Hyprland.usingLua) {
                ...
                delegate: OverviewWindow {
                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            root.draggingTargetWorkspace = -1
                            root.draggingTargetSpecialWorkspace = ""
                            if (targetSpecialWorkspace && targetSpecialWorkspace !== root.specialWorkspaceName(windowData)) {
                                // Idk
                                if (Hyprland.usingLua) {

...
PanelWindow {
	...
	visible: GlobalStates.wallselectOpen
	...
	Component.onCompleted: {
		Quickshell.execDetached([
			"bash",
			Quickshell.shellPath("modules/wallselect/cache.sh"),
			Quickshell.shellDir
		])
	...
	FileView {
		path: Quickshell.shellPath("modules/wallselect/config.json")
		watchChanges: true
	...
	MouseArea {
		...
		onClicked: {
			GlobalStates.wallselectOpen = false
		}
	}
	...
	ListView {
		...
		function activateCurrent() {
			...
			Quickshell.execDetached([
				"bash",
				Quickshell.shellPath("modules/wallselect/commands.sh"),
				path
			])

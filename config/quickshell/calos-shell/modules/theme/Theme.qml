...
PanelWindow {
    ...
    visible: GlobalStates.themeOpen
    ...
    Component.onCompleted: {
        Quickshell.execDetached([
            "bash",
            Quickshell.shellPath("modules/theme/cache.sh"),
            Quickshell.shellDir
        ])
    }

    FileView {
        path: Quickshell.shellPath("modules/theme/config.json")
        watchChanges: true

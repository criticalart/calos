...
ln -snf ~/.config/calos/themes/moonveil ~/.config/calos/current/theme
ln -snf ~/.config/calos/current/theme/backgrounds/moon-loom.png ~/.config/calos/current/background
